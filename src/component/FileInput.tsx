...
const FileInput = ({ algorithm, onChange, handleGraph }: FileInputProps) => {
  return (
    <div className="flex flex-col h-full w-full md:w-1/3 md:min-w-[300px] items-center justify-center shadow-lg z-[0] p-5 gap-5 bg-primaryWhite">
      ...
      <button className="py-3 w-full max-w-[600px] bg-primaryBlue rounded-xl text-primaryWhite hover:scale-[1.01] hover:shadow-lg hover:shadow-dimBlue active:scale-[0.98] transition-all">
